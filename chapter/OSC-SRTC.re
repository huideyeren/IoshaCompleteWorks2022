...
これによって、非日本語話者にメッセージを伝えることができます。現在対応している言語は２０２２年@<tcy>{12}月１日現在で以下の通り@<endnote>{lang}です。
...
さて、このようなステキなツールですが、このツールをいろいろな人に知ってもらいたいと思い、【２０２２年@<tcy>{12}月@<tcy>{10}日（土）　@<tcy>{21}時@<tcy>{00}分から@<tcy>{21}時@<tcy>{50}分】に非公式の紹介イベントを開催します。このツールを使っているところを実演してみたいと考えています。興味ある方、足を運んでいただければ幸いです。

長々とお読みいただき、誠にありがとうございました。

===[column] 後日談：コードでコントリビュートしました

なお、このＯＳＣーＳＲＴＣは@<href>{https://github.com/soumt-r/OSC-SRTC,オープンソースソフトウェア化}されており、コントリビュートできるようになっています。早速私もコントリビュートしました。

//endnote[lang][現在ではタイ語、タガログ語、マレー語、インドネシア語、ヒンディー語、ヘブライ語、トルコ語、ポルトガル語、クロアチア語、オランダ語対応も追加されていますが、アラビア語とヘブライ語に関してはうまく表示できないようです。]
