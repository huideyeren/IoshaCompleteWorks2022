...
このファイルは @<href>{https://github.com/kmuto/pandoc2review} の書式サンプルを利用しています
...
![ラ・ルーン](louisa-vrc.png)

![](louisa-vrc.png)

![](./images/louisa-vrc.png)

![](louisa-vrc.png)

![title](louisa-vrc.png)

![title](louisa-vrc.png){scale=0.5}

![title](louisa-vrc.png){width=50%}

![title](louisa-vrc.png){height=50%}

![title](louisa-vrc.png){width=30}

![title](louisa-vrc.png){width=30% height=50%}

-->
//}

文中の @<icon>{louisa-vrc} というもの。
...
//footnote[fn1][識別子をわざわざ探して打つ必要が無いため、インライン脚注は楽に書けます。]
